%% ROB599_HW3_P5A
% Simiulating a PD Controller with Feed Forward for Robot Arm with Moving Trajectory.
%% Cleanup
clear
clc
close all
...
%% Run Simulation
[tout, xout] = ode45(@(t, x) manipulator(t, x, @PDFeedForward, param, ...
   stamped_x_target), t, x0);

% Compute Torques
tau_values = postComputeTorques(tout, xout, @manipulator, @PDFeedForward, param, stamped_x_target);
...
tLayout.Title.String = "Figure 4.1. Robot Arm State Evolution. Cubic Trajectory Tracking. PD+FF Controller. Kpi = 50. Kdi = 10." + newline;
...
print('output\ROB599-HW#3-Problem5-Fig4.1.png', '-dpng', '-r300');
%% Plot the System Errors

figure('Position', [0, 0, 1200, 1000]);

tLayout = tiledlayout(3,2,'Padding','Compact');
tLayout.Title.String = "Figure 4.2. Robot Arm Errors Evolution. Cubic Trajectory Tracking. PD+FF Controller. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 20;
tLayout.Title.FontWeight = 'bold';
...
print('output\ROB599-HW#3-Problem5-Fig4.2.png', '-dpng', '-r300');
...
tLayout.Title.String = "Figure 4.3. Robot Arm Input Evolution. Cubic Trajectory Tracking. PD+FF Controller. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 20;
tLayout.Title.FontWeight = 'bold';
...
print('output\ROB599-HW#3-Problem5-Fig4.3.png', '-dpng', '-r300');

%% Combined Tall Plot
figure('Position', [0, 0, 1200, 1200]);

tLayout = tiledlayout(7,2,'Padding','Compact');
tLayout.Title.String = "Figure 4. Robot Arm. Cubic Trajectory Tracking. PD+FF Controller. Kpi = 50. Kdi = 10." + newline;
...
print('output\ROB599-HW#3-Problem5A.png', '-dpng', '-r300');
