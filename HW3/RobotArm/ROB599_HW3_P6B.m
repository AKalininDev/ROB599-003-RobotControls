%% ROB599_HW3_P6B
% Simiulating a PD Controller with Inverse Dynamics with Imperfect Model for Robot Arm with Moving Trajectory.
%% Cleanup
clear
clc
close all
...
%% Run Simulation
[tout, xout] = ode45(@(t, x) manipulator(t, x, @PDInverseDynamicsWAcc, param, ...
   stamped_x_target), t, x0);

% Compute Torques
tau_values = postComputeTorques(tout, xout, @manipulator, @PDInverseDynamicsWAcc, param, stamped_x_target);
...
tLayout.Title.String = "Figure 7.1. Robot Arm State Evolution. Cubic Trajectory Tracking. PD+Inverse Dynamics. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 18;
...
tLayout = tiledlayout(3,2,'Padding','Compact');
tLayout.Title.String = "Figure 7.2. Robot Arm Errors Evolution. Cubic Trajectory Tracking. PD+Inverse Dynamics. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 18;
tLayout.Title.FontWeight = 'bold';
...
y_lbl_handle.Position(1) = -0.24;
y_lbl_handle.Position(2) = 0;
...
tLayout.Title.String = "Figure 7.3. Robot Arm Input Evolution. Cubic Trajectory Tracking. PD+Inverse Dynamics. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 18;
tLayout.Title.FontWeight = 'bold';
...
tLayout.Title.String = "Figure 7. Robot Arm. Cubic Trajectory Tracking. PD+Inverse Dynamics. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 13;
tLayout.Title.FontWeight = 'bold';
