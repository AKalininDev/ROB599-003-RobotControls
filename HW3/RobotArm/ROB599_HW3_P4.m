...
sgtitle('Figure 3. Robot Arm. PD Controller w Gravity Comp. Kpi = 50. Kdi = 10.', ...
...
plot(t', x_target(:,2), 'Color', ref_color, 'LineStyle', '--', ...
    'LineWidth', 2, 'DisplayName', '$\mathbf{\dot{q}_1, ref}$, (rad/s)');
hold off;
setSubplotProperties(gca);
...
hold on;
plot(t', x_target(:,2), 'Color', ref_color, 'LineStyle', '--', ...
    'LineWidth', 2, 'DisplayName', '$\mathbf{\dot{q}_2, ref}$, (rad/s)');
hold off;
