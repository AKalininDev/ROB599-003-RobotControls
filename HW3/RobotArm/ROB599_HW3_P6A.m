%% ROB599_HW3_P6A
% Simiulating a PD Controller with Inverse Dynamics for Robot Arm with Moving Trajectory.
%% Cleanup
clear
clc
close all
...
% Initial Conditions
t = linspace(0,4,102000)';
x0 = [0.05;0;0.05;0]; % non-zero initial conditions
tau = [0; 0];
...
%% Run Simulation
[tout, xout] = ode45(@(t, x) manipulator(t, x, @PDInverseDynamics, param, ...
   stamped_x_target), t, x0);

% Compute Torques
tau_values = postComputeTorques(tout, xout, @manipulator, @PDInverseDynamics, param, stamped_x_target);
...
tLayout.Title.String = "Figure 6.1. Robot Arm State Evolution. Cubic Trajectory Tracking. PD+Inverse Dynamics. Kpi = 50. Kdi = 10." + newline;
...
print('output\ROB599-HW#3-Problem6-Fig6.1.png', '-dpng', '-r300');
%% Plot the System Errors

figure('Position', [0, 0, 1200, 1000]);

tLayout = tiledlayout(3,2,'Padding','Compact');
tLayout.Title.String = "Figure 6.2. Robot Arm Errors Evolution. Cubic Trajectory Tracking. PD+Inverse Dynamics. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 20;
tLayout.Title.FontWeight = 'bold';
...
print('output\ROB599-HW#3-Problem6-Fig6.2.png', '-dpng', '-r300');
...
tLayout.Title.String = "Figure 6.3. Robot Arm Input Evolution. Cubic Trajectory Tracking. PD+Inverse Dynamics. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 20;
tLayout.Title.FontWeight = 'bold';
...
print('output\ROB599-HW#3-Problem6-Fig6.3.png', '-dpng', '-r300');

%% Combined Tall Plot
figure('Position', [0, 0, 1200, 1200]);

tLayout = tiledlayout(7,2,'Padding','Compact');
tLayout.Title.String = "Figure 6. Robot Arm. Cubic Trajectory Tracking. PD+Inverse Dynamics. Kpi = 50. Kdi = 10." + newline;
...
print('output\ROB599-HW#3-Problem6A.png', '-dpng', '-r300');
