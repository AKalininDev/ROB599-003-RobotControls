...
tLayout.Title.String = "Figure 5.1. Robot Arm State Evolution. Cubic Trajectory Tracking. PD+FF Controller. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
...
print('output\ROB599-HW#3-Problem5-Fig5.1.png', '-dpng', '-r300');
%% Plot the System Errors

figure('Position', [0, 0, 1200, 1000]);

tLayout = tiledlayout(3,2,'Padding','Compact');
tLayout.Title.String = "Figure 5.2. Robot Arm Errors Evolution. Cubic Trajectory Tracking. PD+FF Controller. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 20;
tLayout.Title.FontWeight = 'bold';
...
print('output\ROB599-HW#3-Problem5-Fig5.2.png', '-dpng', '-r300');
...
tLayout.Title.String = "Figure 5.3. Robot Arm Input Evolution. Cubic Trajectory Tracking. PD+FF Controller. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
tLayout.Title.FontSize = 20;
tLayout.Title.FontWeight = 'bold';
...
print('output\ROB599-HW#3-Problem5-Fig5.3.png', '-dpng', '-r300');

%% Combined Tall Plot
figure('Position', [0, 0, 1200, 1200]);

tLayout = tiledlayout(7,2,'Padding','Compact');
tLayout.Title.String = "Figure 5. Robot Arm. Cubic Trajectory Tracking. PD+FF Controller. 90% Model Accuracy. Kpi = 50. Kdi = 10." + newline;
...
print('output\ROB599-HW#3-Problem5B.png', '-dpng', '-r300');
